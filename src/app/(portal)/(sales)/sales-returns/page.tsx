    ...
    <div className="min-h-screen bg-gray-50/50">
      <div className="w-full max-w-full mx-auto p-8">
        ...
        <PageHeader
          ...
          subtitle="إدارة وعرض جميع مردودات المبيعات والمرتجعات من العملاء"
          action={
            <Link href="/sales-returns/add">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              هنا ستظهر جميع مردودات المبيعات والمرتجعات مع تفاصيل الأسباب والمبالغ المستردة
            </p>
